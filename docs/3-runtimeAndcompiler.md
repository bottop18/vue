...
* esm 代表 es module
* min 代表 minify
* runtime 代表 不把template 给comilper

|                               | UMD html 作为<script scr>专用cdn | CommonJS node export require专用 | ES Module 浏览器import export专用                            |
| ----------------------------- | -------------------------------- | -------------------------------- | ------------------------------------------------------------ |
| **Full**                      | vue.js                           | vue.common.js                    | vue.esm.js                                                   |
| **Runtime-only**              | vue.runtime.js                   | vue.runtime.common.js            | vue.runtime.esm.js dev的admin后台专用![1623504955107](assets/1623504955107.png) |
| **Full (production)**         | vue.min.js                       |                                  |                                                              |
| **Runtime-only (production)** | vue.runtime.min.js               |                                  |                                                              |

![1623505054708](assets/1623505054708.png)
